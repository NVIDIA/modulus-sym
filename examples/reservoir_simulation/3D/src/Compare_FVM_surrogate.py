...
if surrogate ==1:
    ...
    if (bb==False): 
        print('....Downloading Please hold.........')  
        download_file_from_google_drive('11cr3-7zvAZA5zI1SpfevZOQhsYuzAJjy',\
    ...
    if (bba==False):  
        print('....Downloading Please hold.........')               
        download_file_from_google_drive('1EnYGi6MiJum-i-QzbRrpmvsqdR0KSa9a',\
    ...
    if (bb==False):      
        print('....Downloading Please hold.........')      
        download_file_from_google_drive('1unX_CW5_9aTV97LqkRWkYElwsjGkLYdl',\
    ...
    if (bba==False):      
        print('....Downloading Please hold.........')     
        download_file_from_google_drive('1d9Vk9UiVU0sUV2KSh_H4gyH5OVUl2rqS',\
...
see = Peaceman_well(inn,ouut_p,ouut_s,MAXZ,1,1e1,LUB,HUB,aay,bby,DX,steppi,\
                pini_alt,SWI,SWR,UW,BW,DZ,rwell,skin,UO,BO,pwf_producer,dt,N_inj,N_pr,0,nz)
