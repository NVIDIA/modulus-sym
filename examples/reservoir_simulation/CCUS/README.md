...
\quad\quad + w_6 V(q_g,p;\lambda_g)_{\text{pressure equation},\text{CO}_2,g}\\
\quad\quad + w_7 V(q_l,p;\lambda_l)_{\text{pressure equation},\text{CO}_2,l}\\
\quad\quad + w_8 V(p,S_g;t)_{\text{gas equation},\text{CO}_2,g}\\
\quad\quad + w_9 V(q_l,p;\lambda_l)_{\text{pressure equation},H_2 O,l}\\
\quad\quad + w_{10} V(p,S_g;t)_{\text{gas equation},\text{CO}_2,l}\\
\quad\quad + V(p,S_l;t)_{\text{brine equation},H_2 O,l}`$
