...
1. The phase fractions (vp) and phase component fractions (yc,p) are computed as a function of pressure (p), temperature (T), component fractions (zc), and a constant salinity.
1. The phase densities (ρp) and phase viscosities (μp) are computed as a function of pressure, temperature, the updated phase component fractions, and a constant salinity.
