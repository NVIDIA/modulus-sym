...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  1 00:49:38 2023
...
for kk in range(steppi):   
    ...
    Plot_performance_Numerical(bbig,nx,ny,'Jesuss.png',UIR,kk,dt,MAXZ,pini_alt,\
                        steppi,wells)        
...
frames[0].save('Evolution_numerical.gif',format='GIF',\
                append_images=frames[1:],save_all=True,duration=500,loop=0)    
