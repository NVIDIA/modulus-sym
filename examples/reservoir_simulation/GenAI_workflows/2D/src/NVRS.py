...
def prolongation(x, fine_grid_size):
    ...
    blocks = (fine_grid_size + cuda.get_current_device().WARP_SIZE - 1) // cuda.get_current_device().WARP_SIZE
...
def v_cycle(A, b, x, smoother, levels, tol, smoothing_steps):
    ...
    for level in range(levels):
        ...
        if level == levels - 1:
            ...
            coarse_x = v_cycle(coarse_A, coarse_r, cp.zeros_like(coarse_r), \
            smoother, levels-1, tol, smoothing_steps)
...
def gauss_seidel(A, b, x0, omega=1.0, tol=1e-6, max_iters=100):
    ...
    while residual_norm > tol and iters < max_iters:
        dot_products = A @ x
        x_new = (1-omega)*x + omega*(b - dot_products + A.diagonal() * x) / A.diagonal()
...
def Plot_RSM_percentile2(pertoutt,P12,True_mat,Namesz):
    ...
    plt.plot(timezz,True_mat[:,5], color = 'red', lw = '2',\
             label ='model')
    plt.plot(timezz,P10[:,5], color = 'blue', lw = '2', \
             label ='MAP PINO Model')   
    plt.plot(timezz,P12[:,5], color = 'k', lw = '2', \
             label ='MEAN PINO Model')        
    ...
    plt.plot(timezz,P10[:,6], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,6], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    ...
    plt.plot(timezz,P10[:,7], color = 'blue', lw = '2', \
             label ='MAP PINO Model')  
    plt.plot(timezz,P12[:,7], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,8], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,8], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,9], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,9], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,10], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,10], color = 'k', lw = '2', \
             label ='MEAN PINO Model')  
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,11], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,11], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,12], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,12], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,13], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,13], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,14], color = 'blue', lw = '2', \
             label ='MAP PINO Model')  
    plt.plot(timezz,P12[:,14], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,15], color = 'blue', lw = '2', \
             label =' MAP PINO Model') 
    plt.plot(timezz,P12[:,15], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.plot(timezz,P10[:,16], color = 'blue', lw = '2', \
             label ='MAP PINO Model') 
    plt.plot(timezz,P12[:,16], color = 'k', lw = '2', \
             label ='MEAN PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
...
def Plot_RSM_Numerical(pertoutt,True_mat,Namesz):
    ...
    plt.subplot(4,4,1)
    plt.plot(timezz,True_mat[0][:,1],linestyle=linestyles[0], marker=markers[0],markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,1],linestyle=linestyles[1], marker=markers[1],markersize=1,  color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,1],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,1],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,1],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,1],linestyle=linestyles[6], marker=markers[6],markersize=1,  color=colors[6], lw = '2', \
             label ='PINO Model')        
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('BHP(Psia)',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,2)
    plt.plot(timezz,True_mat[0][:,2],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,2],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,2],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,2],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,2],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,2],linestyle=linestyles[6], marker=markers[6],markersize=1,  color=colors[6], lw = '2', \
             label ='PINO Model')        
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('BHP(Psia)',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,3)
    plt.plot(timezz,True_mat[0][:,3],linestyle=linestyles[0], marker=markers[0], markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,3],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,3],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,3],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,3],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,3],linestyle=linestyles[6], marker=markers[6],markersize=1,  color=colors[6], lw = '2', \
             label ='PINO Model')         
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('BHP(Psia)',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,4)
    plt.plot(timezz,True_mat[0][:,4],linestyle=linestyles[0], marker=markers[0], markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,4],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,4],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,4],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,4],linestyle=linestyles[5], marker=markers[5], markersize=1, color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,4],linestyle=linestyles[6], marker=markers[6],markersize=1,  color=colors[6], lw = '2', \
             label ='PINO Model')         
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('BHP(Psia)',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,5)
    plt.plot(timezz,True_mat[0][:,5],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,5],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,5],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,5],linestyle=linestyles[3], marker=markers[3], markersize=1, color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,5],linestyle=linestyles[5], marker=markers[5], markersize=1, color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,5],linestyle=linestyles[6], marker=markers[6],markersize=1,  color=colors[6], lw = '2', \
             label ='PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,6)
    plt.plot(timezz,True_mat[0][:,6],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,6],linestyle=linestyles[1], marker=markers[1],markersize=1,  color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,6],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,6],linestyle=linestyles[3], marker=markers[3], markersize=1, color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,6],linestyle=linestyles[5], marker=markers[5], color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,6],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')        
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,7)
    plt.plot(timezz,True_mat[0][:,7],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,7],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,7],linestyle=linestyles[2], marker=markers[2], markersize=1, color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,7],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,7],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,7],linestyle=linestyles[6], marker=markers[6],markersize=1,  color=colors[6], lw = '2', \
             label ='PINO Model')         
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,8)
    plt.plot(timezz,True_mat[0][:,8],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,8],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,8],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,8],linestyle=linestyles[3], marker=markers[3], markersize=1, color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,8],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,8],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')         
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,9)
    plt.plot(timezz,True_mat[0][:,9],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,9],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,9],linestyle=linestyles[2], marker=markers[2], markersize=1, color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,9],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,9],linestyle=linestyles[5], marker=markers[5], markersize=1, color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,9],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')         
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,10)
    plt.plot(timezz,True_mat[0][:,10],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,10],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,10],linestyle=linestyles[2], marker=markers[2], markersize=1, color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,10],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,10],linestyle=linestyles[5], marker=markers[5], markersize=1, color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,10],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')        
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,11)
    plt.plot(timezz,True_mat[0][:,11],linestyle=linestyles[0], marker=markers[0], markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,11],linestyle=linestyles[1], marker=markers[1],markersize=1,  color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,11],linestyle=linestyles[2], marker=markers[2], markersize=1, color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,11],linestyle=linestyles[3], marker=markers[3], markersize=1, color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,11],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,11],linestyle=linestyles[6], marker=markers[6],markersize=1,  color=colors[6], lw = '2', \
             label ='PINO Model')         
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,12)
    plt.plot(timezz,True_mat[0][:,12],linestyle=linestyles[0], marker=markers[0], markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,12],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,12],linestyle=linestyles[2], marker=markers[2], markersize=1, color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,12],linestyle=linestyles[3], marker=markers[3], markersize=1, color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,12],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,12],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,13)
    plt.plot(timezz,True_mat[0][:,13],linestyle=linestyles[0], marker=markers[0], markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,13],linestyle=linestyles[1], marker=markers[1],markersize=1,  color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,13],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,13],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,13],linestyle=linestyles[5], marker=markers[5], markersize=1, color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,13],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,14)
    plt.plot(timezz,True_mat[0][:,14],linestyle=linestyles[0], marker=markers[0],markersize=1,  color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,14],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,14],linestyle=linestyles[2], marker=markers[2],markersize=1,  color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,14],linestyle=linestyles[3], marker=markers[3],markersize=1,  color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,14],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,14],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,15)
    plt.plot(timezz,True_mat[0][:,15],linestyle=linestyles[0], marker=markers[0], markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,15],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,15],linestyle=linestyles[2], marker=markers[2], markersize=1, color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,15],linestyle=linestyles[3], marker=markers[3], markersize=1, color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,15],linestyle=linestyles[5], marker=markers[5],markersize=1,  color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,15],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')          
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.subplot(4,4,16)
    plt.plot(timezz,True_mat[0][:,16],linestyle=linestyles[0], marker=markers[0], markersize=1, color=colors[0],lw = '2',\
             label ='Left-preconditioned GMRES')
    plt.plot(timezz,True_mat[1][:,16],linestyle=linestyles[1], marker=markers[1], markersize=1, color=colors[1],lw = '2',\
             label ='spsolve')        
    plt.plot(timezz,True_mat[2][:,16],linestyle=linestyles[2], marker=markers[2], markersize=1, color=colors[2], lw = '2',\
             label ='Left-preconditioned conjugate gradient') 
    plt.plot(timezz,True_mat[3][:,16],linestyle=linestyles[3], marker=markers[3], markersize=1, color=colors[3], lw = '2',\
             label ='LSQR')         
    plt.plot(timezz,True_mat[4][:,16],linestyle=linestyles[5], marker=markers[5], markersize=1, color=colors[5], lw = '2',\
             label ='CPR')                
    plt.plot(timezz,P10[:,16],linestyle=linestyles[6], marker=markers[6], markersize=1, color=colors[6], lw = '2', \
             label ='PINO Model')         
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$WWCT{%}$',fontsize = 13)
    #plt.ylim((0,25000))
    ...
    plt.suptitle('COMPARISON BETWEEN THE PINO SOLVER AND 6 NUMERICAL SOLVERS',\
    fontsize = 16)
    #os.chdir('RESULTS')     
    plt.savefig(Namesz)          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
...
def Plot_performance(PINN,PINN2,trueF,nx,ny,namet,UIR,itt,dt,MAXZ,pini_alt,\
                    steppi,wells):
...
def Plot_performance_Numerical(trueF,nx,ny,namet,UIR,itt,dt,MAXZ,pini_alt,\
                    steppi,wells):
...
def Peaceman_well(inn,ooutp,oouts,MAXZ,mazw,s1,LUB,HUB,aay,bby,DX,steppi,\
                pini_alt,SWI,SWR,UW,BW,DZ,rwell,skin,UO,BO,pwf_producer,dt,N_inj,N_pr,nz):  
    """
    ...
    Injector_location = np.where(inn["Qw"][0,0,:,:].detach().cpu().numpy().ravel()>0)[0]    
    producer_location = np.where(inn["Q"][0,0,:,:].detach().cpu().numpy().ravel()<0)[0]
    

    PERM = rescale_linear_pytorch_numpy(np.reshape(inn["perm"][0,0,:,:].detach().cpu().numpy(),(-1,),'F'),\
                                        LUB,HUB, aay, bby) 
...
def Peaceman_well2(inn,ooutp,oouts,MAXZ,mazw,s1,LUB,HUB,aay,bby,DX,steppi,\
                pini_alt,SWI,SWR,UW,BW,DZ,rwell,skin,UO,BO,pwf_producer,dt,N_inj,N_pr,nz):  
    """
    Calculates the pressure and flow rates for an injection and production well using the Peaceman model.
...
def Upstream_2PHASE(nx,ny,nz,S,UW,UO,BW,BO,SWI,SWR,Vol,qinn,V,Tt,porosity):
    """
...
def RelPerm2(Sa, UW, UO, BW, BO, SWI, SWR, nx, ny, nz):
    ...
    return cp.reshape(Mw, (-1, 1), 'F'), cp.reshape(Mo, (-1, 1), 'F'),\
           cp.reshape(dMw, (-1, 1), 'F'), cp.reshape(dMo, (-1, 1), 'F')

    
def NewtRaph(nx,ny,nz,porosity,Vol,S,V,qinn,Tt,UW,UO,SWI,SWR,method2,typee,BW,BO):
    """
    ...
    while conv==0:
        ...
        while I < 2**IT:
            ...
            while (dsn > 0.001) and (it < 10):
                ...
                df=cp.divide(dMw,(Mw+Mo))-cp.multiply(cp.divide(Mw,((Mw+Mo)**(2))),(dMw+dMo))  #dMw/(Mw + Mo)-Mw/(Mw+Mo)**(2)*(dMw+dMo)
                df = cp.ravel(df)
                dG=sparse.eye(N,dtype=cp.float32)-B@spdiags(df,0,N,N,format='csr')
                ...
                if method2 == 1: #GMRES
                    ...
                    ds,exitCode = gmres(-dG, G,tol=1e-6, atol=0, restart=20, maxiter=100,M=M)                    
...
def calc_rs(p_bub, p):
    ...
    if p < p_bub:
        ...
        rs_factor = 0
    rs = 178.11 ** 2 / 5.615 * ((p / p_bub) ** 1.3 * rs_factor + \
                                (1 - rs_factor))
    return rs
...
##############################################################################
def Reservoir_Simulator(Kuse,porosity,quse,quse_water,nx,ny,nz,factorr,max_t,\
 Dx,Dy,Dz,BO,BW,CFL,timmee,MAXZ,PB,PATM,CFO,IWSw,method,steppi,SWI,SWR,UW,UO,typee,\
     step2,pini_alt):
    ...
    for t in range(tc2.shape[0]-1):
        ...
        if method == 1: #GMRES
            ...
            u = v_cycle(A, b, x = cp.zeros_like(b),smoother ='SOR', levels=2, \
                        tol = 1e-6, smoothing_steps=2)            
        ...
        V = {'x':cp.zeros((Nx+1,Ny,Nz)), 'y':cp.zeros((Nx,Ny+1,Nz)), \
        ...
        if CFL == 1:
            S = Upstream_2PHASE(nx,ny,nz,S,UW,UO,BW,BO,SWI,SWR,Vol,quse_water,V,dt,porosity)
        else:
            for ts in range(step2):
                S = NewtRaph(nx,ny,nz,porosity,Vol,S,V,quse_water,\
                           St/float(step2),UW,UO,SWI,SWR,method,typee,BW,BO)            
...
def Get_actual_few(ini,nx,ny,nz,max_t,Dx,Dy,Dz,BO,BW,CFL,timmee,MAXZ,factorr,steppi,\
                   LIR,UIR,LUB,HUB,aay,bby,mpor,hpor,dt,IWSw,PB,PATM,CFO,method,\
                    SWI,SWR,UW,UO,typee,step2,pini_alt,input_channel,pena):
    ...
    for kk in range(Ne):
        ...
        points = np.reshape(np.random.randint(1,nx,16),(-1,2),'F')# 16 is total number of wells
        ...
        #print(A)
        A_out = Reservoir_Simulator(a,at2,quse.ravel(),quse_water.ravel(),nx,\
                ny,1,factorr,max_t,Dx,Dy,Dz,BO,BW,CFL,timmee,MAXZ,PB,PATM,CFO,\
                IWSw,method,steppi,SWI,SWR,UW,UO,typee,step2,pini_alt)
...
def Get_actual_few_parallel(ini,nx,ny,nz,max_t,Dx,Dy,Dz,BO,BW,CFL,timmee,MAXZ,factorr,steppi,\
                   LIR,UIR,LUB,HUB,aay,bby,mpor,hpor,dt,IWSw,PB,PATM,CFO,method,\
                    SWI,SWR,UW,UO,typee,step2,pini_alt,input_channel,pena):
...
def No_Sim(ini,nx,ny,nz,max_t,Dx,Dy,Dz,BO,BW,CFL,timmee,MAXZ,factorr,steppi,\
                   LIR,UIR,LUB,HUB,aay,bby,mpor,hpor,dt,IWSw,PB,PATM,CFO,method,\
                    SWI,SWR,UW,UO,typee,step2,pini_alt,input_channel,pena):
...
def inference_single(ini,inip,nx,ny,nz,max_t,Dx,Dy,Dz,BO,BW,CFL,timmee,MAXZ,\
                     factorr,steppi,\
                   LIR,UIR,LUB,HUB,aay,bby,mpor,hpor,dt,IWSw,PB,PATM,CFO,method,\
                    SWI,SWR,UW,UO,typee,step2,pini_alt,input_channel,kka):
    ...
    for kk in range(Ne):
        ...
        quse_water = np.reshape(A1,(-1,1),'F')
        #print(A)
        A_out = Reservoir_Simulator(a,at2,quse.ravel(),\
                quse_water.ravel(),nx,ny,nz,factorr,max_t,\
                    Dx,Dy,Dz,BO,BW,CFL,timmee,MAXZ,PB,PATM,CFO,\
                    IWSw,method,steppi,SWI,SWR,UW,UO,typee,step2,pini_alt)
...
def compute_f(pressure,kuse,krouse,krwuse,rwell1,\
                         skin,pwf_producer1,UO,BO,DX,UW,BW,DZ):   
