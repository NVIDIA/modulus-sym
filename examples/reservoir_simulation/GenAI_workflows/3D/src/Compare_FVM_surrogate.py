...
frames[0].save('Evolution_pressure.gif',format='GIF',\
...
frames[0].save('Evolution_water.gif',format='GIF',\
                append_images=frames[1:],save_all=True,duration=500,loop=0)    
...
frames[0].save('Evolution_oil.gif',format='GIF',\
                append_images=frames[1:],save_all=True,duration=500,loop=0) 
...
seeTrue = Peaceman_well(inn,data_use1[:,:steppi,:,:,:],\
                ...
                pini_alt,SWI,SWR,UW,BW,DZ,rwell,skin,UO,BO,pwf_producer,dt,N_inj,N_pr,1,nz)
