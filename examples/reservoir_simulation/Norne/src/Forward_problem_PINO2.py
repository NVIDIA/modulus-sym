...
def Black_oil_peacemann(UO,BO,UW,BW,DZ,RE,in_var,out_var,device,max_inn_fcn,max_out_fcn,paramz,p_bub, p_atm,CFO,device):
...
def Black_oil(neededM,input_var,SWI,SWR,UW,BW,UO,BO,
             ...
             minP,maxP,p_bub,p_atm,CFO,maxQx,maxQwx,maxTx,maxQgx,Relperm,params,pde_method,device):
...
'fault': inputaa['fault'],'Pini': inputaa['Pini'],'Swini':inputaa['Swini']}
            ...
            f_loss2, f_water2,f_gass2 = Black_oil(neededM,input_varr,SWI,SWR,UW,BW,UO,BO,
             ...
             minPx,maxPx,p_bub,p_atm,CFO,maxQx,maxQwx,maxTx,maxQgx,Relperm,params,pde_method,device) 
            ...
            out_train_p["Y"],device,max_inn_fcnx,max_out_fcnx,params,p_bub, p_atm,CFO,device)
            loss_pdeb = Black_oil_peacemann(UO,BO,UW,BW,DZ,RE,inn_train_p["X"],
            outputa_pe,device,max_inn_fcnx,max_out_fcnx,params,p_bub, p_atm,CFO,device)
