...
def Forward_model_ensemble(N,x_true,steppi,min_inn_fcn,max_inn_fcn,
                 ...
                 ,modelW1,modelG1,modelO1,device,modelP2,
...
decoder5 = ConvFullyConnectedArch([Key("z", size=32)], \
            [Key("oil_sat", size=steppi)])
modelO = FNOArch([Key("perm", size=1),Key("Phi", size=1), Key("Pini", size=1),\
            Key("Swini", size=1),Key("fault", size=1) ],\
dimension=3, decoder_net=decoder5) 
...
while (snn<1):        
    ...
    simDatafinal,predMatrix,_,_,_,_ = Forward_model_ensemble(ensemble.shape[1],\
                         ...
                         ,modelW,modelG,modelO,device,model_peacemann,
                         min_out_fcn,max_out_fcn,Time,effectiveuse,Trainmoe,num_cores,pred_type,
                         oldfolder,degg,experts)                 
