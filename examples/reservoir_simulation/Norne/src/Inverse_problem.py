...
def Forward_model_ensemble(N,x_true,steppi,min_inn_fcn,max_inn_fcn,
...
#### ===================================================================== #### 
    ...
    for clem in range(N):        
        temp = {'perm': x_true['perm'][clem,:,:,:,:][None,:,:,:,:],\
    ...
    perm = convert_back(x_true["perm"].detach().cpu().numpy() ,target_min,target_max,minK,maxK)
    ...
    if Trainmoe ==1:
        ...
        for clem in range(N):        
            ...
            with torch.no_grad():    
                ...
                ouut_p1 = convert_back(ouut_p1.detach().cpu().numpy() ,target_min,target_max,min_out_fcn,max_out_fcn)
...
def Get_data_FFNN1(folder,oldfolder,N,pressure,Sgas,Swater,perm,Time,steppi,steppi_indices): 
...
def historydatano(timestep,steppi,steppi_indices): 
    ...
    ## IMPORT FOR OIL
    A2oilsim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=1545, sep='\s+', header=None)
    ...
    A22oilsim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=1801, sep='\s+', header=None)
    B_4DHoilsim = A22oilsim[1].values[:steppii]
    B_4Hoilsim = A22oilsim[2].values[:steppii]
    D_1CHoilsim = A22oilsim[3].values[:steppii]    
    D_1Hoilsim = A22oilsim[4].values[:steppii]    
    ...
    A222oilsim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=2057, sep='\s+', header=None)
    ...
    ##IMPORT FOR WATER
    A2watersim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=2313, sep='\s+', header=None)
    B_1BHwatersim = A2watersim[9].values[:steppii]

    A22watersim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=2569, sep='\s+', header=None)
    B_1Hwatersim = A22watersim[1].values[:steppii]
    B_2Hwatersim = A22watersim[2].values[:steppii]
    B_3Hwatersim = A22watersim[3].values[:steppii]
    B_4BHwatersim = A22watersim[4].values[:steppii]  
    ...
    A222watersim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=2825, sep='\s+', header=None)
    D_3AHwatersim = A222watersim[1].values[:steppii]
    D_3BHwatersim = A222watersim[2].values[:steppii]
    D_4AHwatersim = A222watersim[3].values[:steppii]    
    D_4Hwatersim = A222watersim[4].values[:steppii]
    ...
    A222watersim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=3081, sep='\s+', header=None)
    E_3Hwatersim = A222watersim[1].values[:steppii]
    E_4AHwatersim = A222watersim[2].values[:steppii]
    K_3Hwatersim = A222watersim[3].values[:steppii]
    ...
    ## GAS PRODUCTION RATE
    A2gassim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=1033, sep='\s+', header=None)
    B_1BHgassim  = A2gassim[1].values[:steppii]
    B_1Hgassim  = A2gassim[2].values[:steppii]
    B_2Hgassim  = A2gassim[3].values[:steppii]
    B_3Hgassim  = A2gassim[4].values[:steppii]
    ...
    A22gassim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=1289, sep='\s+', header=None)
    D_2Hgassim = A22gassim[1].values[:steppii]
    D_3AHgassim = A22gassim[2].values[:steppii]
    D_3BHgassim = A22gassim[3].values[:steppii]
    D_4AHgassim = A22gassim[4].values[:steppii]    
    ...
    A222gassim = pd.read_csv('../NORNE/FULLNORNE.RSM', skiprows=1545, sep='\s+', header=None)
    E_3CHgassim = A222gassim[1].values[:steppii] 
    E_3Hgassim = A222gassim[2].values[:steppii]
    E_4AHgassim = A222gassim[3].values[:steppii]
    K_3Hgassim = A222gassim[4].values[:steppii] 
...
def Plot_2DD(XX,YY,plt,nx,ny,nz,Truee,N_injw,N_pr,N_injg,varii,injectors,producers,gass):
    if Truee.ndim == 3:
        Pressz = np.reshape(Truee,(nx,ny,nz),'F')
        avg_2d = np.mean(Pressz, axis=2)
    else:
...
def Plot_mean(permbest,permmean,iniperm,nx,ny,Low_K,High_K,True_perm): 
    ...
    Plot_2D(XX,YY,plt,nx,ny,nz,permmean,N_injw,N_pr,N_injg,'perm',injectors,producers,gass)
    ...
    plt.subplot(2, 2, 2)
    Plot_2D(XX,YY,plt,nx,ny,nz,permbest,N_injw,N_pr,N_injg,'perm',injectors,producers,gass)
    ...
    plt.subplot(2, 2, 3)
    Plot_2D(XX,YY,plt,nx,ny,nz,iniperm,N_injw,N_pr,N_injg,'perm',injectors,producers,gass)
    ...
    plt.subplot(2, 2, 4)
    Plot_2D(XX,YY,plt,nx,ny,nz,True_perm,N_injw,N_pr,N_injg,'perm',injectors,producers,gass)
...
def Plot_petrophysical(permmean,poroo,nx,ny,nz,Low_K,High_K):
    ...
    plt.subplot(2, 2, 2)
    Plot_2D(XX,YY,plt,nx,ny,nz,temp_K,N_injw,N_pr,N_injg,'perm',injectors,producers,gass)
    ...
    plt.subplot(2, 2, 3)
    Plot_2D(XX,YY,plt,nx,ny,nz,poroo,N_injw,N_pr,N_injg,'poro',injectors,producers,gass)
    ...
    plt.subplot(2, 2, 4)
    Plot_2D(XX,YY,plt,nx,ny,nz,temp_phi,N_injw,N_pr,N_injg,'poro',injectors,producers,gass)
...
def Plot_RSM_percentile(pertoutt,True_mat,timezz):
    ...
    for k in range(22):
        ...
        plt.plot(timezz,P10[:,k], color = 'blue', lw = '2', \
                 label ='P10 Model')
        plt.plot(timezz,P50[:,k], color = 'c', lw = '2', \
                 label ='P50 Model')
        plt.plot(timezz,P90[:,k], color = 'green', lw = '2', \
             label ='P90 Model')
            
        plt.plot(timezz,arekibest[:,k], color = 'k', lw = '2', \
             label ='aREKI cum best Model')

        plt.plot(timezz,amean[:,k], color = 'purple', lw = '2', \
             label ='aREKI cum MAP Model')

        plt.plot(timezz,base[:,k], color = 'orange', lw = '2', \
    ...
    for k in range(22):
        ...
        plt.plot(timezz,P10[:,k+22], color = 'blue', lw = '2', \
                 label ='P10 Model')
        plt.plot(timezz,P50[:,k+22], color = 'c', lw = '2', \
                 label ='P50 Model')
        plt.plot(timezz,P90[:,k+22], color = 'green', lw = '2', \
             label ='P90 Model')
            
        plt.plot(timezz,arekibest[:,k+22], color = 'k', lw = '2', \
             label ='aREKI cum best Model')
        plt.plot(timezz,amean[:,k+22], color = 'purple', lw = '2', \
             label ='aREKI cum MAP Model')

        plt.plot(timezz,base[:,k+22], color = 'orange', lw = '2', \
             label ='Base case Model')               
    ...
    for k in range(22):
        ...
        plt.plot(timezz,P10[:,k+44], color = 'blue', lw = '2', \
                 label ='P10 Model')
        plt.plot(timezz,P50[:,k+44], color = 'c', lw = '2', \
                 label ='P50 Model')
        plt.plot(timezz,P90[:,k+44], color = 'green', lw = '2', \
             label ='P90 Model')
            
        plt.plot(timezz,arekibest[:,k+44], color = 'k', lw = '2', \
             label ='aREKI cum best Model')

        plt.plot(timezz,amean[:,k+44], color = 'purple', lw = '2', \
             label ='aREKI cum MAP Model')

        plt.plot(timezz,base[:,k+44], color = 'orange', lw = '2', \
             label ='Base case Model')               
    ...
    cc10 = ((np.sum(((( P10) - True_data) ** 2)) )  **(0.5)) \
        /True_data.shape[0]
    print('RMSE of P10 reservoir model  =  ' \
        + str(cc10) )  
        

    P50 = np.reshape(P50,(-1,1),'F')
    cc50 = ((np.sum(((( P50) - True_data) ** 2)) )  **(0.5)) \
        /True_data.shape[0]
    print('RMSE of P50 reservoir model  =  ' \
        + str(cc50) )  
    ...
    cc90 = ((np.sum(((( P90) - True_data) ** 2)) )  **(0.5)) \
        /True_data.shape[0]
    print('RMSE of P90 reservoir model  = : ' \
        + str(cc90) ) 
    
    P99 = np.reshape(arekibest,(-1,1),'F')
    cc99 = ((np.sum(((( P99) - True_data) ** 2)) )  **(0.5)) \
        /True_data.shape[0]
    print('RMSE of cummulative best reservoir model  =  ' \
        + str(cc99) )
        

    Pmean = np.reshape(amean,(-1,1),'F')
    ccmean = ((np.sum(((( Pmean) - True_data) ** 2)) )  **(0.5)) \
        /True_data.shape[0]
    print('RMSE of cummulative mean reservoir model  =  ' \
        + str(ccmean) )  
        
       

    Pbase = np.reshape(base,(-1,1),'F')
    ccbase = ((np.sum(((( Pbase) - True_data) ** 2)) )  **(0.5)) \
        /True_data.shape[0]
    print('RMSE of base case reservoir model  =  ' \
        + str(ccbase) ) 
    ...
    plt.savefig('Histogram.png')          # save as png                                  # preventing the figures from showing
    plt.clf()
    plt.close()
...
def Plot_RSM_single(True_mat,timezz):
    ...
    #os.chdir('RESULTS')     
    plt.savefig('Oil_single.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close()
    ...
    #os.chdir('RESULTS')     
    plt.savefig('Water_single.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close()    
    ...
    #os.chdir('RESULTS')     
    plt.savefig('Gas_single.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close() 
...
def Plot_RSM_singleT(True_mat,timezz):
    ...
    #os.chdir('RESULTS')     
    plt.savefig('Oil_singleT.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close()
    ...
    #os.chdir('RESULTS')     
    plt.savefig('Water_singleT.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close()    
    ...
    #os.chdir('RESULTS')     
    plt.savefig('Gas_singleT.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close() 
...
def Plot_RSM(predMatrix,True_mat,Namesz,Ne,timezz):
    ...
    plt.plot(timezz,True_mat[:,0], color = 'red', lw = '2',\
             label ='True model')
    ...
    plt.subplot(5,5,5)
    plt.plot(timezz,WOPRE[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,6)
    plt.plot(timezz,WOPRF[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,7)
    plt.plot(timezz,WOPRG[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,8)
    plt.plot(timezz,WOPRH[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,9)
    plt.plot(timezz,WOPRI[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,10)
    plt.plot(timezz,WOPRJ[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,11)
    plt.plot(timezz,WOPRK[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,12)
    plt.plot(timezz,WOPRL[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,13)
    plt.plot(timezz,WOPRM[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,14)
    plt.plot(timezz,WOPRN[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,15)
    plt.plot(timezz,WOPRO[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,16)
    plt.plot(timezz,WOPRP[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,17)
    plt.plot(timezz,WOPRQ[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    ...
    plt.subplot(5,5,18)
    plt.plot(timezz,WOPRR[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    plt.title(columns[17],fontsize = 13)

    plt.plot(timezz,True_mat[:,17], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,19)
    plt.plot(timezz,WOPRS[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    plt.title(columns[18],fontsize = 13)

    plt.plot(timezz,True_mat[:,18], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,20)
    plt.plot(timezz,WOPRT[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    plt.title(columns[19],fontsize = 13)

    plt.plot(timezz,True_mat[:,19], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,21)
    plt.plot(timezz,WOPRU[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    plt.title(columns[20],fontsize = 13)

    plt.plot(timezz,True_mat[:,20], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,22)
    plt.plot(timezz,WOPRV[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    plt.title(columns[21],fontsize = 13)

    plt.plot(timezz,True_mat[:,21], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.savefig('Oil_'+Namesz+'.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close() 
    ...
    plt.plot(timezz,True_mat[:,22], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.plot(timezz,True_mat[:,23], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.plot(timezz,True_mat[:,24], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.plot(timezz,True_mat[:,25], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,5)
    plt.plot(timezz,WWPRE[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[4],fontsize = 13)

    plt.plot(timezz,True_mat[:,26], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,6)
    plt.plot(timezz,WWPRF[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[5],fontsize = 13)

    plt.plot(timezz,True_mat[:,27], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,7)
    plt.plot(timezz,WWPRG[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[6],fontsize = 13)

    plt.plot(timezz,True_mat[:,28], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,8)
    plt.plot(timezz,WWPRH[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[7],fontsize = 13)

    plt.plot(timezz,True_mat[:,29], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,9)
    plt.plot(timezz,WWPRI[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[8],fontsize = 13)

    plt.plot(timezz,True_mat[:,30], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,10)
    plt.plot(timezz,WWPRJ[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[9],fontsize = 13)

    plt.plot(timezz,True_mat[:,31], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,11)
    plt.plot(timezz,WWPRK[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[10],fontsize = 13)

    plt.plot(timezz,True_mat[:,32], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,12)
    plt.plot(timezz,WWPRL[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[11],fontsize = 13)

    plt.plot(timezz,True_mat[:,33], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,13)
    plt.plot(timezz,WWPRM[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[12],fontsize = 13)

    plt.plot(timezz,True_mat[:,34], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,14)
    plt.plot(timezz,WWPRN[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[13],fontsize = 13)

    plt.plot(timezz,True_mat[:,35], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,15)
    plt.plot(timezz,WWPRO[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[14],fontsize = 13)

    plt.plot(timezz,True_mat[:,36], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,16)
    plt.plot(timezz,WWPRP[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[15],fontsize = 13)

    plt.plot(timezz,True_mat[:,37], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,17)
    plt.plot(timezz,WWPRQ[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[16],fontsize = 13)

    plt.plot(timezz,True_mat[:,38], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,18)
    plt.plot(timezz,WWPRR[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[17],fontsize = 13)

    plt.plot(timezz,True_mat[:,39], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,19)
    plt.plot(timezz,WWPRS[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[18],fontsize = 13)

    plt.plot(timezz,True_mat[:,40], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,20)
    plt.plot(timezz,WWPRT[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[19],fontsize = 13)

    plt.plot(timezz,True_mat[:,41], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,21)
    plt.plot(timezz,WWPRU[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{water}(bbl/day)$',fontsize = 13)
    plt.title(columns[20],fontsize = 13)

    plt.plot(timezz,True_mat[:,42], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,22)
    plt.plot(timezz,WWPRV[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{oil}(bbl/day)$',fontsize = 13)
    plt.title(columns[21],fontsize = 13)

    plt.plot(timezz,True_mat[:,43], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.savefig('Water_'+Namesz+'.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close()
    ...
    plt.subplot(5,5,1)
    plt.plot(timezz,WGPRA[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[0],fontsize = 13)

    plt.plot(timezz,True_mat[:,44], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,2)
    plt.plot(timezz,WGPRB[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[1],fontsize = 13)

    plt.plot(timezz,True_mat[:,45], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,3)
    plt.plot(timezz,WGPRC[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[2],fontsize = 13)

    plt.plot(timezz,True_mat[:,46], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,4)
    plt.plot(timezz,WGPRD[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[3],fontsize = 13)

    plt.plot(timezz,True_mat[:,47], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,5)
    plt.plot(timezz,WGPRE[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[4],fontsize = 13)

    plt.plot(timezz,True_mat[:,48], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,6)
    plt.plot(timezz,WGPRF[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[5],fontsize = 13)

    plt.plot(timezz,True_mat[:,49], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,7)
    plt.plot(timezz,WGPRG[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[6],fontsize = 13)

    plt.plot(timezz,True_mat[:,50], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,8)
    plt.plot(timezz,WGPRH[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[7],fontsize = 13)

    plt.plot(timezz,True_mat[:,51], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,9)
    plt.plot(timezz,WGPRI[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[8],fontsize = 13)

    plt.plot(timezz,True_mat[:,52], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,10)
    plt.plot(timezz,WGPRJ[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[9],fontsize = 13)

    plt.plot(timezz,True_mat[:,53], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,11)
    plt.plot(timezz,WGPRK[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(bbl/day)$',fontsize = 13)
    plt.title(columns[10],fontsize = 13)

    plt.plot(timezz,True_mat[:,54], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,12)
    plt.plot(timezz,WGPRL[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[11],fontsize = 13)

    plt.plot(timezz,True_mat[:,55], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,13)
    plt.plot(timezz,WGPRM[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[12],fontsize = 13)

    plt.plot(timezz,True_mat[:,56], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,14)
    plt.plot(timezz,WGPRN[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[13],fontsize = 13)

    plt.plot(timezz,True_mat[:,57], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,15)
    plt.plot(timezz,WGPRO[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[14],fontsize = 13)

    plt.plot(timezz,True_mat[:,58], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,16)
    plt.plot(timezz,WGPRP[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[15],fontsize = 13)

    plt.plot(timezz,True_mat[:,59], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,17)
    plt.plot(timezz,WGPRQ[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(bbl/day)$',fontsize = 13)
    plt.title(columns[16],fontsize = 13)

    plt.plot(timezz,True_mat[:,60], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,18)
    plt.plot(timezz,WGPRR[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[17],fontsize = 13)

    plt.plot(timezz,True_mat[:,61], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.plot(timezz,True_mat[:,62], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.plot(timezz,True_mat[:,63], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.subplot(5,5,21)
    plt.plot(timezz,WGPRU[:,:Ne],color = 'grey', lw = '2',\
             label = 'Realisations')
    plt.xlabel('Time (days)',fontsize = 13)
    plt.ylabel('$Q_{gas}(scf/day)$',fontsize = 13)
    plt.title(columns[20],fontsize = 13)

    plt.plot(timezz,True_mat[:,64], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.plot(timezz,True_mat[:,65], color = 'red', lw = '2',\
             label ='True model')
    plt.axvline(x = 1500, color = 'black', linestyle = '--')
    handles, labels = plt.gca().get_legend_handles_labels()     # get all the labels
    by_label = OrderedDict(zip(labels,handles))                 # OrderedDict forms a ordered dictionary of all the labels and handles, but it only accepts one argument, and zip does this 
    ...
    plt.savefig('Gas_'+Namesz+'.png')          # save as png                                  # preventing the figures from showing
    #os.chdir(oldfolder)
    plt.clf()
    plt.close()
...
def plot_and_save(kk,dt,pree,wats,oilss,gasss,nx, ny, nz, N_injw, N_pr, 
                N_injg, injectors, producers, gass,effectiveuse):
    current_time = dt[kk]
    ...
    Plot_Modulus(ax1, nx, ny, nz, look, N_injw, N_pr, N_injg, 'pressure Modulus', injectors, producers, gass)

    look = (wats[0, kk, :, :, :]) * effectiveuse
    ax2 = f_3.add_subplot(2, 2, 2, projection='3d')
    Plot_Modulus(ax2, nx, ny, nz, look, N_injw, N_pr, N_injg, 'water Modulus', injectors, producers, gass)

    look = oilss[0, kk, :, :, :]
    look = look * effectiveuse
    ax3 = f_3.add_subplot(2, 2, 3, projection='3d')
    Plot_Modulus(ax3, nx, ny, nz, look, N_injw, N_pr, N_injg, 'oil Modulus', injectors, producers, gass)

    look = ((gasss[0, kk, :, :, :])) * effectiveuse
    ax4 = f_3.add_subplot(2, 2, 4, projection='3d')
    Plot_Modulus(ax4, nx, ny, nz, look, N_injw, N_pr, N_injg, 'gas Modulus', injectors, producers, gass)
...
N_injw = len(plan["custom"]["WELLSPECS"]["water_injector_wells"])  # Number of water injectors
N_pr = len(plan["custom"]["WELLSPECS"]["producer_wells"])  #Number of producers
N_injg = len(plan["custom"]["WELLSPECS"]["gas_injector_wells"])  # Number of gas injectors
...
if (DEFAULT==1):
    ...
    while True:
        do_localisation = int(input('Do covariance localisation duirng Kalman update:\n\
    1 = Yes\n\
    2 = No\n'))
...
modelP = FNOArch([Key("perm", size=1),Key("Phi", size=1), Key("Pini", size=1),\
...
modelW = FNOArch([Key("perm", size=1),Key("Phi", size=1), Key("Pini", size=1),\
            Key("Swini", size=1),Key("fault", size=1) ],\
dimension=3, decoder_net=decoder2) 
    
decoder3 = ConvFullyConnectedArch([Key("z", size=32)], \
            [Key("gas_sat", size=steppi)])
modelG = FNOArch([Key("perm", size=1),Key("Phi", size=1), Key("Pini", size=1),\
            Key("Swini", size=1),Key("fault", size=1) ],\
...
decoder4 = ConvFullyConnectedArch([Key("z", size=32)], \
            [Key("Y", size=66)])
model_peacemann = FNOArch([Key("X", size=90) ],\
...
bb = os.path.isfile("outputs/Forward_problem_PINO/ResSim/fno_forward_model_pressure.0.pth")
if (bb==False): 
    print('....Downloading Please hold.........')  
    download_file_from_google_drive('1lyojCxW4aHKVm5XM66zKWdW6W8aYbO2F',\
...
if (bb==False): 
    print('....Downloading Please hold.........')  
    download_file_from_google_drive('1QH4QnkwSwfoMgAqp_MxrVVt25ylbzUqv',\
...
if (bb==False): 
    print('....Downloading Please hold.........')  
    download_file_from_google_drive('1QvnH4kcRSu-Q0WgzY7LPWbWkohPOvSIT',\
...
bba = os.path.isfile("outputs/Forward_problem_PINO/ResSim/fno_forward_model_peacemann.0.pth")
if (bba==False):  
    print('....Downloading Please hold.........')               
    download_file_from_google_drive('1kyST2aMmqTAdfv-C6MI4CKd3Vi-4Ja4F',\
...
if (DEFAULT==1):
    ...
    Trainmoe = None
    while True:
        Trainmoe = int(input('Select 1 = Inference peacemann with FNO | 2 = Inference peacemann with Mixture of Experts \n'))
        if (Trainmoe>2) or (Trainmoe<1):
            ...
            break
if Trainmoe ==2:
    TEMPLATEFILE['Peaceman modelling inference'] = 'Inference peacemann = Mixture of Experts'
else:
...
percentage of data value = 1:\nConstant float value = 2:\n'))
        if (BASSE>2) or (BASSE<1):
            ...
            break 
if BASSE ==1:
    TEMPLATEFILE['Covariance matrix generation'] = 'Covariance noise matrix generation = data percentage\n'
else:
    TEMPLATEFILE['Covariance matrix generation'] = 'Covariance noise matrix generation = constant value\n'
...
print('--------------------------ADAPTIVE-REKI----------------------------------')
print('History Matching using the Adaptive Regularised Ensemble Kalman Inversion with covariance localisation')
print('Novel Implementation by Clement Etienam, SA-Nvidia: SA-ML/A.I/Energy')

batch_clem = 1
 
Technique_REKI =1
TEMPLATEFILE['Data assimilation method'] = 'ADAPT_REKI (Vanilla Adaptive Ensemble Kalman Inversion)\n'
...
if DEFAULT ==1:
    ...
    Ne = None
    while True:
        Ne = int(input('Number of realisations used for history matching (100-5000) : '))
        N_ens = Ne
...
if Ne==100:  
    ...
    ini_ensemble,ini_ensemblep = honour2(ini_ensemblep,\
                                 ini_ensemble,nx,ny,nz,N_ens,\
...
while (snn<1):        
    ...
    ensemblepy = ensemble_pytorch(ensemble,ensemblep,ensemblef,\
    nx,ny,nz,Ne,effective,oldfolder,target_min,target_max,minK,maxK,minT,\
    maxT,minP,maxP,minQ,maxQ,minQw,maxQw,minQg,maxQg,steppi,device,steppi_indices)
    ...
    simDatafinal,predMatrix,_,_,_,_ = Forward_model_ensemble(ensemble.shape[1],\
                                ensemblepy,steppi,min_inn_fcn,max_inn_fcn,
    ...
    overall=cp.vstack([cp.asarray(sgsim1),cp.asarray(ensemblep1),cp.asarray(ensemblef)])
...
ensemblepy = ensemble_pytorch(ensemble,ensemblep,ensemblef,\
                     nx,ny,nz,ensemble.shape[1],effective,oldfolder,\
                         target_min,target_max,minK,maxK,\
...
simDatafinal,predMatrix,pressure_ensemble,water_ensemble,oil_ensemble,gas_ensemble\
= Forward_model_ensemble(ensemble.shape[1],\
                            ensemblepy,steppi,min_inn_fcn,max_inn_fcn,
                     target_min,target_max,minK,maxK,minT,maxT,minP,maxP,modelP
                     ,modelW,modelG,device,model_peacemann,
                     min_out_fcn,max_out_fcn,Time,effectiveuse,Trainmoe,num_cores,pred_type,
...
ensemblepya = ensemble_pytorch(all_ensemble,all_ensemblep,all_ensemblef,\
                     nx,ny,nz,all_ensemble.shape[1],effective,oldfolder,\
                    target_min,target_max,minK,maxK,\
                     minT,maxT,minP,maxP,minQ,maxQ,minQw,maxQw,minQg,\
                    maxQg,steppi,device,steppi_indices)         
...
mazw = 0 # Dont smooth the presure field
simDatafinala,predMatrixa,pressure_ensemblea,water_ensemblea,oil_ensemblea,gas_ensemblea = \
Forward_model_ensemble(all_ensemble.shape[1],\
                            ensemblepya,steppi,min_inn_fcn,max_inn_fcn,
                     target_min,target_max,minK,maxK,minT,maxT,minP,maxP,modelP
                     ,modelW,modelG,device,model_peacemann,
                     min_out_fcn,max_out_fcn,Time,effectiveuse,Trainmoe,num_cores,pred_type,
                     oldfolder)                               
...
ensemblepy = ensemble_pytorch(controlbest,controlbestp,controlbestf,\
                     nx,ny,nz,controlbest.shape[1],effective,oldfolder,\
                    target_min,target_max,minK,maxK,\
                     minT,maxT,minP,maxP,minQ,maxQ,minQw,maxQw,minQg,\
                    maxQg,steppi,device,steppi_indices)

mazw = 0 # Dont smooth the presure field
_,yycheck,pree,wats,oilss,gasss = \
    Forward_model_ensemble(controlbest.shape[1],\
                                ensemblepy,steppi,min_inn_fcn,max_inn_fcn,
                         target_min,target_max,minK,maxK,minT,maxT,minP,maxP,modelP
                         ,modelW,modelG,device,model_peacemann,
                         min_out_fcn,max_out_fcn,Time,effectiveuse,Trainmoe,num_cores,pred_type,
...
'Simulated_data_plots':yycheck,'Pressure': pree,\
   'Water_saturation':wats,'Oil_saturation':oilss,'gas_saturation':gasss} 
...
cc=((np.sum(((( usesim) - True_data) ** 2)) )  **(0.5)) \
    /True_data.shape[0]
print('RMSE  =  ' \
    + str(cc) )
os.chdir('../HM_RESULTS')
...
ensemblepy = ensemble_pytorch(yes_best_k,yes_best_p,yes_best_f,\
                     nx,ny,nz,controlbest2.shape[1],effective,oldfolder,\
                    target_min,target_max,minK,maxK,\
                     minT,maxT,minP,maxP,minQ,maxQ,minQw,maxQw,minQg,\
                    maxQg,steppi,device,steppi_indices)        
...
X_data1 = {'permeability':yes_best_k,\
'porosity':yes_best_p,\
'Simulated_data_plots':yycheck,'Pressure': preebest,\
   'Water_saturation':watsbest,'Oil_saturation':oilssbest,'gas_saturation':gasbest}
...
ensemblepy = ensemble_pytorch(yes_mean_k,yes_mean_p,yes_mean_f,\
                             nx,ny,nz,controlbest2.shape[1],effective,oldfolder,\
                            target_min,target_max,minK,maxK,\
                             minT,maxT,minP,maxP,minQ,maxQ,minQw,maxQw,minQg,\
                            maxQg,steppi,device,steppi_indices) 
...
X_data1 = {'permeability':yes_mean_k,\
'porosity':yes_mean_p,\
'Simulated_data_plots':yycheck,'Pressure': preebest,\
   'Water_saturation':watsbest,'Oil_saturation':oilssbest,'Gas_saturation':gasbest} 
...
X_data1 = {'PERM_Reali':ensemble,\
	...
	'Simulated_data_plots':predMatrix,'Pressures': pressure_ensemble,\
	   'Water_saturation':water_ensemble,'Oil_saturation':oil_ensemble,'Gas_saturation':gas_ensemble,\
	...
	'Simulated_data_plots_best_ensemble':predMatrixa,'Pressures_best_ensemble': \
	   ...
	   'Water_saturation_best_ensemble':water_ensemblea,\
	       'Oil_saturation_best_ensemble':oil_ensemblea,'Gas_saturation_best_ensemble':gas_ensemblea}
    

os.chdir(oldfolder)

ensembleout1=np.hstack([controlbest,controljj2,controlbad,yes_best_k,yes_mean_k,base_k])
ensembleoutp1=np.hstack([controlbestp,controljj2p,controlbadp,yes_best_p,yes_mean_p,base_p])
ensembleoutf1=np.hstack([controlbestf,controljj2f,controlbadf,yes_best_f,yes_mean_f,base_f])
...
ensemblepy = ensemble_pytorch(ensembleout1,ensembleoutp1,ensembleoutf1,\
                             nx,ny,nz,ensembleoutf1.shape[1],effective,oldfolder,\
                            target_min,target_max,minK,maxK,\
                             minT,maxT,minP,maxP,minQ,maxQ,minQw,maxQw,minQg,\
                            maxQg,steppi,device,steppi_indices) 
...
X_data1 = {'PERM_Reali':ensembleout1,\
'PORO_Reali':ensembleoutp1,\
'Simulated_data_plots':yzout,'Pressures': pressure_percentile,\
   'Water_saturation':water_percentile,'Oil_saturation':oil_percentile,'Gas_saturation':gas_percentile}  
